        ...
        <div className="hero-inner">
          <div className="hero-left">
            ...
            <div className="hero-ctas">
              ...
              <a href="https://github.com/thecatthatflies/sonar" className="btn-outline" target="_blank" rel="noopener noreferrer">
          ...
          <div className="download-cards">
            ...
            <div className="dl-card reveal">
              ...
              <div className="dl-buttons">
                <a href="https://github.com/thecatthatflies/sonar/releases/latest/download/Sonar_aarch64.dmg" className="dl-btn">
                  <span>Apple Silicon</span>
                  <span className="dl-ext">.dmg</span>
                </a>
                <a href="https://github.com/thecatthatflies/sonar/releases/latest/download/Sonar_x64.dmg" className="dl-btn-outline">
                  <span>Intel</span>
                  <span className="dl-ext">.dmg</span>
                </a>
              </div>
            ...
            <div className="dl-card reveal reveal-d1">
              ...
              <div className="dl-buttons">
                <a href="https://github.com/thecatthatflies/sonar/releases/latest/download/Sonar_x86_64.AppImage" className="dl-btn">
                  <span>x86_64</span>
                  <span className="dl-ext">.AppImage</span>
                </a>
                <a href="https://github.com/thecatthatflies/sonar/releases/latest/download/Sonar_aarch64.AppImage" className="dl-btn-outline">
                  <span>ARM64</span>
                  <span className="dl-ext">.AppImage</span>
                </a>
              </div>
